...
namespace MissionPlanner.GCSViews
{
    public partial class FlightData : MyUserControl, IActivate, IDeactivate
    {
        ...
        public FlightData(GpsLocator gpsLocator)
        {
            log.Info("Ctor Start");
        ...
        void BindLabels()
        {
            ...
            BindSingleLabel("DISTANCE TO BASE", "DistFromMovingBase");
        ...
        SerialPort ProperPort = new SerialPort();
        public static System.Threading.Thread MarkerPrintingThread;
        ...
        private void mainloop()
        {
            ...
            while (threadrun)
            {
                ...
                try
                {
                    ...
                    if (!PosPrintThreadrun)
                    {
                        PosPrintThreadrun = true;
                        
                        PosPrinter = new System.Threading.Thread(new System.Threading.ThreadStart(gpsLocator.CurrentPositionPrinter))
                        {
                            IsBackground = true,
                            Name = "GpsPositionPrinter",
        ...
        public Thread PosPrinter { get; private set; }
